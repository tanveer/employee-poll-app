...
export function handleInitialData() {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      console.error(
        "Error occurred while fetching initial data:",
        error.message
      );
    }
  };
...
export function handleSaveNewPollQuestion(authedUser, optionOne, optionTwo) {
  return async (dispatch, getState) => {
    console.log("From State", getState().authedUser);
    try {
